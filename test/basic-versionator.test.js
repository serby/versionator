...
describe('versionator', function() {
    ...
    describe('#versionPath', function() {
      ...
      it('should URLs with querystring', function() {
        ...
        basic
          ...
          .should.eql('/js/v0.0.0/test-bar.js?test=1')
      })
      ...
      it('should basic URLs with hash', function() {
        ...
        basic
          ...
          .should.eql('/js/v0.0.0/test-bar.js#hashy')
      })
      ...
      it('should basic URLs with querystring and hash', function() {
        ...
        basic
          ...
          .should.eql('/js/v0.0.0/test-bar.js?test=1#hashy')
      })
  ...
  describe('basic middleware', function() {
    function startServer(port) {
      var app = appEngine()
        .use(versionator.createBasic('v0.1.2').middleware)
